...
class YamahaTX81zSingleEditor extends PatchEditorFrame
{
  ...
  scrollPane.add(effectPane,gbc);
   ...
   while (i!=5)
   {
	...
	new EnvelopeNode(0,31,new ParamModel(patch,i*13+47),30,30,null,10,true,new VcedSender(i*13),null," AR",null),
	new EnvelopeNode(0,31,new ParamModel(patch,i*13+48),0,15,new ParamModel(patch,i*13+51),25,true,new VcedSender(i*13+1),new VcedSender(i*13+4),"D1R","D1L"),
	new EnvelopeNode(0,31,new ParamModel(patch,i*13+49),0,0,null,10,true,new VcedSender(i*13+2),null,"D2R",null),
	new EnvelopeNode(1,15,new ParamModel(patch,i*13+50),0,0,null,0,true,new VcedSender(i*13+3),null,"RR",null),
