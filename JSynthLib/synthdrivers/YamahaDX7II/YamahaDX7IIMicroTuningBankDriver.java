 ...
 * file:    YamahaDX7IIMicroTuningBankDriver.java
 * date:    25.02.2003
 * @version 0.1
 *
...
public class YamahaDX7IIMicroTuningBankDriver extends BankDriver
{
  public YamahaDX7IIMicroTuningBankDriver()
  {
    ...
    patchNameStart=0;
    patchNameSize=0;
    bankNumbers  = DX7IIConstants.BANK_NUMBERS_MICRO_TUNING_BANK;
    patchNumbers = DX7IIConstants.PATCH_NUMBERS_MICRO_TUNING_BANK;
  ...
  public void storePatch (Patch p, int bankNum,int patchNum)
  {
    if( ((YamahaDX7IIDevice)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getTipsMsgFlag()==1 )
          ...
          JOptionPane.showMessageDialog(PatchEdit.instance,
                                        getDriverName()+"Driver:"+ DX7IIStrings.MICRO_TUNING_CARTRIDGE_STRING,
