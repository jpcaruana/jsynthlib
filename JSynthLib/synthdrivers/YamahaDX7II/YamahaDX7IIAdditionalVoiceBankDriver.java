 ...
 * file:    YamahaDX7IIAdditionalVoiceBankDriver.java
 * date:    25.02.2003
 * @version 0.1
 *
...
public class YamahaDX7IIAdditionalVoiceBankDriver extends BankDriver
{
  public YamahaDX7IIAdditionalVoiceBankDriver()
  {
    manufacturer="Yamaha";
    model="DX7-II";
    patchType="Additional Voice Bank";
    id="DX7-II";
    ...
    patchNameStart=0;
    patchNameSize=0;
    bankNumbers  = DX7IIConstants.BANK_NUMBERS_BANK_ADDITIONAL_VOICE;
    patchNumbers = DX7IIConstants.PATCH_NUMBERS_ADDITIONAL_VOICE;
  ...
  public void storePatch (Patch p, int bankNum,int patchNum)
  {
    ...
    DX7IIParamChanges.chRcvBlock(port, (byte)(channel+0x10), (byte)(bankNum));
  ...
  public void requestPatchDump(int bankNum, int patchNum)
  {
    ...
    DX7IIParamChanges.chXmitBlock(port, (byte)(channel+0x10), (byte)(bankNum));
  ...
  {
    int start=(35*patchNum); // single-patch-size in bulked-dump-packed-format
