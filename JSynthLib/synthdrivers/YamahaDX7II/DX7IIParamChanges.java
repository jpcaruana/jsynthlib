/*
 * JSynthlib - Parameter Changes for Yamaha DX7-II
 * ===============================================
 * @author  Torsten Tittmann
 * file:    DX7IIParamChanges.java
 * date:    25.02.2003
 * @version 0.1
 *
...
import core.*;
public class DX7IIParamChanges
{
  ...
  { Button.send(p, ch, new NameValue("switch", 0x24), new NameValue("OnOff", 0x7f)); }	// switch 36
}
