/*
 * JSynthlib - "Additional Voice" Editor for Yamaha TX802
 * ======================================================
 * @author  Torsten Tittmann
 * file:    YamahaTX802AdditionalVoiceEditor.java
 * date:    25.02.2003
 * @version 0.1
 *
...
class YamahaTX802AdditionalVoiceEditor extends PatchEditorFrame 
{
  static final String [] OnOffName          = new String [] {"Off","On"};

  static final String [] OpScaleModeName    = new String [] {"normal","fractional"};

  static final String [] OpAmpModSensName   = new String [] {"0","1","2","3","4","5","6","7"};

  static final String [] LfoKeyTriggerName  = new String [] {"single","multi"};

  static final String [] PitchEgRangeName   = new String [] {"8 octave","4 octave","1 octave","1/2 octave"};

  static final String [] KeyModeName        = new String [] {"Polyphonic","Monophonic","Unison poly","Unison Mono"};
  ...
  static final String [] PitchBendModeName  = new String [] {"normal","low","high","key on"};

  static final String [] PortamentoModeName = new String [] {"Retain/Fingered","Follow/Full Time"};

  static final String [] PortamentoStepName = new String [] { "smooth",                 //
                                                              "perfect First (Unison)", // Prime
                                                              "minor Second",           // kleine Sekunde
                                                              "major Second",           // groﬂe  Sekunde
                                                              "minor Third",            // kleine Terz
  ...
  public YamahaTX802AdditionalVoiceEditor(Patch patch)
  {
    super ("Yamaha TX802 \"Additional Voice\" Editor",patch);
    ...
    gbc.gridx=4;gbc.gridy=18;gbc.gridwidth=8;gbc.gridheight=1; cmnPane.add(new JLabel("Only Polyphonic/Monophonic Mode; NO Unison Modes!"),gbc);
    ...
    gbc.gridx=0;gbc.gridy=4;gbc.gridwidth=3;gbc.gridheight=1; ctrlPane.add(new JLabel("Foot Control: "),gbc);
