 ...
 * file:    YamahaTX802AdditionalVoiceBankDriver.java
 * date:    25.02.2003
 * @version 0.1
 *
...
public class YamahaTX802AdditionalVoiceBankDriver extends BankDriver
{
  public YamahaTX802AdditionalVoiceBankDriver()
  {
    ...
    patchNameStart=0;
    patchNameSize=0;
    bankNumbers  = TX802Constants.BANK_NUMBERS_BANK_ADDITIONAL_VOICE;
  ...
  public void storePatch (Patch p, int bankNum,int patchNum)
  {
    ...
    // choose the desired MIDI Receive block (internal (1-32), internal (33-64)) (the TX802 uses this message for both ReceiveBlock and TransmitBlock)
