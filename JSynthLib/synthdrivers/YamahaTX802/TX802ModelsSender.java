/*
 * JSynthlib - Parameter Models/Sysex Sender for Yamaha TX802
 * ==========================================================
 * @author  Torsten Tittmann
 * file:    TX802ModelsSender.java
 * date:    25.02.2003
 * @version 0.1
 *
...
class PerformanceModel extends ParamModel
{
  ...
  public void set(int i)
  {
    patch.sysex[ofs  ] = (byte)(TX802ParamChanges.Value2AsciiHexHigh(i) );
    patch.sysex[ofs+1] = (byte)(TX802ParamChanges.Value2AsciiHexLow( i) );
  }
  public int get()
  {
     return (
              (byte)( TX802ParamChanges.AsciiHex2Value( patch.sysex[ofs  ] ) *16 +
                      TX802ParamChanges.AsciiHex2Value( patch.sysex[ofs+1] ) )
            );
  }
}
