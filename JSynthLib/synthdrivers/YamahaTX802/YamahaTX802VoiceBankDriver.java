...
public class YamahaTX802VoiceBankDriver extends BankDriver
{
  public YamahaTX802VoiceBankDriver()
  {
    ...
    deviceIDoffset=2;
    bankNumbers  = TX802Constants.BANK_NUMBERS_BANK_VOICE;
  ...
  public Patch getPatch(Patch bank, int patchNum) //Gets a patch from the bank, converting it as needed
  {
    try
    {
      ...
      return p;
    }catch (Exception e) {ErrorMsg.reportError(manufacturer+" "+model,"Error "+getDriverName(),e);return null;}
  }
