...
class YamahaFS1RVoiceEditor extends PatchEditorFrame
{
	...
	*/
	private Container buildFilterWindow() {
		...
		EnvelopeWidget oEnv = new EnvelopeWidget("Envelope Generator",p,new EnvelopeNode []
		{
        new EnvelopeNode(0,0,null, 50, 50,null,0,false,null,null,null,null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x69), 0, 100,new FS1RModel(p, 0x66), 0,false,new FS1RSender(0x69), new FS1RSender(0x66),"R1","L1"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x6A), 0, 100,new FS1RModel(p, 0x67), 0,false,new FS1RSender(0x6A), new FS1RSender(0x67),"R2","L2"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x6B), 0, 100,new FS1RModel(p, 0x68), 0,false,new FS1RSender(0x6B), new FS1RSender(0x68),"R3","L3"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x6C), 0, 100,new FS1RModel(p, 0x65), 0,false,new FS1RSender(0x6C), new FS1RSender(0x65),"R4","L4")
		});
	...
	*/
	private Container buildPitchWindow() {
		...
		{
        new EnvelopeNode(0,0,null, 50, 50,null,0,false,null,null,null,null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x23), 0, 100,new FS1RModel(p, 0x1F), 0,false,new FS1RSender(0x23), new FS1RSender(0x1F),"R1","L1"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x24), 0, 100,new FS1RModel(p, 0x20), 0,false,new FS1RSender(0x24), new FS1RSender(0x20),"R2","L2"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x25), 0, 100,new FS1RModel(p, 0x21), 0,false,new FS1RSender(0x25), new FS1RSender(0x21),"R3","L3"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x26), 0, 100,new FS1RModel(p, 0x22), 0,false,new FS1RSender(0x26), new FS1RSender(0x22),"R4","L4")
		});
		oEnv.setPreferredSize(new Dimension(ENV_WIDTH, ENV_HEIGHT));
		oPanel4.add(oEnv);
		Box oPane = Box.createVerticalBox();
...
//		oPanel5.setLayout(new FlowLayout(FlowLayout.LEFT));
		...
		EnvelopeWidget oEnv = new EnvelopeWidget("Amplitude Envelope Generator",p,new EnvelopeNode []
		{
        new EnvelopeNode(0,0,null, 0, 0,null,0,false,null,null,null,null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x14, aOp), 0, 0, null, 0, false, new FS1RSender(0x14), null, "Hold", null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x10, aOp), 0, 99,new FS1RModel(p, 0x0C, aOp), 0,false,new FS1RSender(0x10, aOp), new FS1RSender(0x0C, aOp),"R1","L1"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x11, aOp), 0, 99,new FS1RModel(p, 0x0D, aOp), 0,false,new FS1RSender(0x11, aOp), new FS1RSender(0x0D, aOp),"R2","L2"),
			new EnvelopeNode(0, 99, new FS1RModel(p, 0x12, aOp), 0, 99,new FS1RModel(p, 0x0E, aOp), 0,false,new FS1RSender(0x12, aOp), new FS1RSender(0x0E, aOp),"R3","L3"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x13, aOp), 0, 99,new FS1RModel(p, 0x0F, aOp), 0,false,new FS1RSender(0x13, aOp), new FS1RSender(0x0F, aOp),"R4","L4")
		});
		//oEnv.setPreferredSize(new Dimension(ENV_WIDTH, ENV_HEIGHT));
		oPanel5.add(oEnv);
		oPanel5.add(Box.createHorizontalStrut(5));
		
		oEnv = new EnvelopeWidget("Frequency Envelope Generator",p,new EnvelopeNode []
		{
//        new EnvelopeNode(50, 50, null, 0, 0, null,0,false,null,null,null,null),
        new EnvelopeNode(0, 0, null, 0, 0x64, new FS1RModel(p, 8, aOp), 0, false, null, new FS1RSender(8, aOp), null, "Initial level"),
        new EnvelopeNode(0, 0x63, new FS1RModel(p, 0x0A, aOp), 0, 0x64, new FS1RModel(p, 9, aOp), 0, false, new FS1RSender(0x14, aOp), new FS1RSender(9, aOp), "Attack time", "Attack level"),
        new EnvelopeNode(0, 0x63, new FS1RModel(p, 0x0B, aOp), 0, 0, null, 0, false, new FS1RSender(0x0B, aOp), null, "Decay", null)
		});
		//oEnv.setPreferredSize(new Dimension(ENV_WIDTH, ENV_HEIGHT));
		oPanel5.add(oEnv);
		oPane.add(oPanel5);
...
//		JPanel oPanel5 = new JPanel(new GridLayout(1, 2)); 
		EnvelopeWidget oEnvAmp = new EnvelopeWidget("Amplitude Envelope Generator",p,new EnvelopeNode []
		{
        new EnvelopeNode(0,0,null, 0, 0,null,0,false,null,null,null,null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x38, aOp), 0, 0, null, 0, false, new FS1RSender(0x38), null, "Hold", null),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x34, aOp), 0, 99,new FS1RModel(p, 0x30, aOp), 0,false,new FS1RSender(0x34, aOp), new FS1RSender(0x30, aOp),"R1","L1"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x35, aOp), 0, 99,new FS1RModel(p, 0x31, aOp), 0,false,new FS1RSender(0x35, aOp), new FS1RSender(0x31, aOp),"R2","L2"),
		new EnvelopeNode(0, 99, new FS1RModel(p, 0x36, aOp), 0, 99,new FS1RModel(p, 0x32, aOp), 0,false,new FS1RSender(0x36, aOp), new FS1RSender(0x32, aOp),"R3","L3"),
        new EnvelopeNode(0, 99, new FS1RModel(p, 0x37, aOp), 0, 99,new FS1RModel(p, 0x33, aOp), 0,false,new FS1RSender(0x37, aOp), new FS1RSender(0x33, aOp),"R4","L4")
		});
		...
		EnvelopeWidget oEnvFreq = new EnvelopeWidget("Frequency Envelope Generator",p,new EnvelopeNode []
		{
        new EnvelopeNode(0, 0, null, 0, 0x64, new FS1RModel(p, 0x2A, aOp), 0, false, null, new FS1RSender(0x2A, aOp), null, "Initial level"),
        new EnvelopeNode(0, 0x63, new FS1RModel(p, 0x2C, aOp), 0, 0x64, new FS1RModel(p, 0x2B, aOp), 0, false, new FS1RSender(0x2C, aOp), new FS1RSender(0x2B, aOp), "Attack time", "Attack level"),
        new EnvelopeNode(0, 0x63, new FS1RModel(p, 0x2D, aOp), 0, 0, null, 0, false, new FS1RSender(0x2D, aOp), null, "Decay", null)
		});
