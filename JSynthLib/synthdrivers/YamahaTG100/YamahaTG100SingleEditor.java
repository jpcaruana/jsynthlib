...
public class YamahaTG100SingleEditor extends PatchEditorFrame {
    ...
    public YamahaTG100SingleEditor(Patch patch) {
    ...
    */
	private Container buildCommonWindow() {
		...
		// Voice Mode
		ComboBoxWidget voiceModeWidget = new ComboBoxWidget("Voice Mode", p, new TG100Model(p, 7), new TG100Sender(0x00), TG100Constants.VOICE_MODE);
        ...
        gbc.gridy = 1;
        gbc.gridwidth = 2;
		commonPanel.add(new ScrollBarWidget("Portamento Time", p, 0, 127, 0, new TG100Model(p, 12),  new TG100Sender(0x05) ), gbc );
		// Mod LFO Pitch Depth
		gbc.gridy = 2;
		commonPanel.add(new ScrollBarWidget("Mod LFO Pitch Depth", p, 0, 15, 0, new TG100Model(p, 13),  new TG100Sender(0x06) ), gbc );
		// CAF LFO Pitch Depth
		gbc.gridx = 2;
		gbc.gridwidth = 1;
		commonPanel.add(new ScrollBarWidget("CAF LFO Pitch Depth", p, 0, 15, 0, new TG100Model(p, 15),  new TG100Sender(0x08) ), gbc );
		...
		gbc.gridx = 0;
        gbc.gridy = 0;
		element1Panel.add(new ScrollBarWidget("Element 1 Level", p, 0, 127, 0, new TG100Model(p, 8),  new TG100Sender(0x01) ), gbc );
		// Element 1 Detune
		gbc.gridx = 2;
		element1Panel.add(new ScrollBarWidget("Element 1 Detune", p, 32, 95, -64, new TG100Model(p, 10),  new TG100Sender(0x03) ), gbc );
		// Element 1 Pitch Rate Scaling
		gbc.gridx = 0;
        gbc.gridy = 1;
		element1Panel.add(new ComboBoxWidget("Element 1 Pitch Rate Scaling", p, new TG100Model(p, 17), new TG100Sender(0x0A), TG100Constants.PITCH_RATE_SCALING), gbc);
		// Element 1 Pitch Rate Center Note
		gbc.gridx = 1;
		element1Panel.add(new ComboBoxWidget("Element 1 Pitch Rate Center Note", p, new TG100Model(p, 18), new TG100Sender(0x0B), TG100Constants.NOTES), gbc);
		// Element 1 Note Shift
		gbc.gridx = 2;
		element1Panel.add(new ScrollBarWidget("Element 1 Note Shift", p, 40, 88, -64, new TG100Model(p, 19),  new TG100Sender(0x0C) ), gbc );
		...
		gbc.gridx = 0;
        gbc.gridy = 0;
		element2Panel.add(new ScrollBarWidget("Element 2 Level", p, 0, 127, 0, new TG100Model(p, 9),  new TG100Sender(0x02) ), gbc  );
		// Element 2 Detune
		gbc.gridx = 2;
		element2Panel.add(new ScrollBarWidget("Element 2 Detune", p, 32, 95, -64, new TG100Model(p, 11),  new TG100Sender(0x04) ), gbc  );
		// Element 2 Pitch Rate Scaling
		gbc.gridx = 0;
        gbc.gridy = 1;
		element2Panel.add(new ComboBoxWidget("Element 2 Pitch Rate Scaling", p, new TG100Model(p, 21), new TG100Sender(0x0E), TG100Constants.PITCH_RATE_SCALING), gbc );
		// Element 2 Pitch Rate Center Note
		gbc.gridx = 1;
		element2Panel.add(new ComboBoxWidget("Element 2 Pitch Rate Center Note", p, new TG100Model(p, 22), new TG100Sender(0x0F), TG100Constants.NOTES), gbc );
		// Element 2 Note Shift
		gbc.gridx = 2;
		element2Panel.add(new ScrollBarWidget("Element 2 Note Shift", p, 40, 88, -64, new TG100Model(p, 20),  new TG100Sender(0x0D) ), gbc  );
    ...
    */
	private Container buildElementWindow(final int element) {
		...
		// Waveform
		oPanel1.add(new ScrollBarWidget("Waveform", p, 0, 139, 0, new TG100Model(p, 31 + offset, true),  new TG100Sender(0x18 + offset) ) );
		// EG AR
		oPanel1.add(new ScrollBarWidget("EG AR", p, 49, 79, -64, new TG100Model(p, 33 + offset),  new TG100Sender(0x1A + offset) ) );
		// EG RR
		oPanel1.add(new ScrollBarWidget("EG RR", p, 49, 79, -64, new TG100Model(p, 34 + offset),  new TG100Sender(0x1B + offset) ) );
...
/*
		...
		EnvelopeWidget pitchEnvelope = new EnvelopeWidget("  Envelope", p, new EnvelopeWidget.Node [] {
        	...
        	new EnvelopeWidget.Node(0, 63, new TG100Model(p, 57 + offset),
        	                        0, 127, new TG100Model(p, 62 + offset),
        	                        -64, true, new TG100Sender(0x3E + offset), new TG100Sender(0x43 + offset),
        	                        "P-EG R1","P-EG L1"),
            new EnvelopeWidget.Node(0, 63, new TG100Model(p, 58 + offset),
        	                        0, 127, new TG100Model(p, 63 + offset),
        	                        -64, true, new TG100Sender(0x3F + offset), new TG100Sender(0x44 + offset),
        	                        "P-EG R2","P-EG L2"),
            new EnvelopeWidget.Node(0, 63, new TG100Model(p, 59 + offset),
        	                        0, 127, new TG100Model(p, 64 + offset),
        	                        -64, true, new TG100Sender(0x40 + offset), new TG100Sender(0x45 + offset),
        	                        "P-EG R3","P-EG L3"),
            new EnvelopeWidget.Node(0, 63, new TG100Model(p, 60 + offset),
        	                        0, 127, new TG100Model(p, 65 + offset),
