...
public class DX7Strings
{
  ...
  protected final static String MEMORY_PROTECTION_STRING=
                "\n\nHave you disabled the memory protection of your DX7?"+
  ...
  protected final static String PERFORMANCE_STRING =
		"\n\nThe DX7 doesn't support the requesting and transmitting of a"+
                "\nsingle performance patch!"+
                "\n\nThe DX7 supports only the receiving of a single performance patch"+
