...
public class YamahaDX7VoiceBankDriver extends BankDriver
{
	...
	{
		super ("Bank","Torsten Tittmann",DX7Constants.PATCH_NUMBERS_VOICE.length,4);
	...
	public void storePatch (Patch p, int bankNum,int patchNum)
	{
		...
		if ( ((YamahaDX7Device)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getDX7sPBPflag()==1 ) {
			...
			DX7ParamChanges.chBank(getPort(), (byte)(getChannel()+0x10), (byte)(0x25));
		} else {
			if ( ((YamahaDX7Device)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getTipsMsgFlag()==1 )
				// Information
				JOptionPane.showMessageDialog(PatchEdit.instance,
	...
	public void requestPatchDump(int bankNum, int patchNum)
	{
		if ( ((YamahaDX7Device)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getDX7sPBPflag()==1 ) {
			...
			DX7ParamChanges.xmitBankDump(getPort(), (byte)(getChannel()+0x10));
		} else {
			if ( ((YamahaDX7Device)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getTipsMsgFlag()==1 )
				// Information
				JOptionPane.showMessageDialog(PatchEdit.instance,
	...
	public void putPatch(Patch bank,Patch p,int patchNum) //puts a patch into the bank, converting it as needed
	{
		...
		bank.sysex[getPatchStart(patchNum)+ 11]=(byte)((p.sysex[6+ 12]*4+p.sysex[6+ 11]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 12]=(byte)((p.sysex[6+ 20]*8+p.sysex[6+ 13]));	// Osc Detune .................(0-14)
		...
		bank.sysex[getPatchStart(patchNum)+ 15]=(byte)((p.sysex[6+ 18]*2+p.sysex[6+ 17]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
		...
		bank.sysex[getPatchStart(patchNum)+ 28]=(byte)((p.sysex[6+ 33]*4+p.sysex[6+ 32]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 29]=(byte)((p.sysex[6+ 41]*8+p.sysex[6+ 34]));	// Osc Detune .................(0-14)
													// | Kbd Rate Scaling .........(0-7)
		...
		bank.sysex[getPatchStart(patchNum)+ 32]=(byte)((p.sysex[6+ 39]*2+p.sysex[6+ 38]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
		...
		bank.sysex[getPatchStart(patchNum)+ 45]=(byte)((p.sysex[6+ 54]*4+p.sysex[6+ 53]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 46]=(byte)((p.sysex[6+ 62]*8+p.sysex[6+ 55]));	// Osc Detune .................(0-14)
													// | Kbd Rate Scaling .........(0-7)
		...
		bank.sysex[getPatchStart(patchNum)+ 49]=(byte)((p.sysex[6+ 60]*2+p.sysex[6+ 59]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
		...
		bank.sysex[getPatchStart(patchNum)+ 62]=(byte)((p.sysex[6+ 75]*4+p.sysex[6+ 74]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 63]=(byte)((p.sysex[6+ 83]*8+p.sysex[6+ 76]));	// Osc Detune .................(0-14)
													// | Kbd Rate Scaling .........(0-7)
		...
		bank.sysex[getPatchStart(patchNum)+ 66]=(byte)((p.sysex[6+ 81]*2+p.sysex[6+ 80]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
		...
		bank.sysex[getPatchStart(patchNum)+ 79]=(byte)((p.sysex[6+ 96]*4+p.sysex[6+ 95]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 80]=(byte)((p.sysex[6+104]*8+p.sysex[6+ 97]));	// Osc Detune .................(0-14)
													// | Kbd Rate Scaling .........(0-7)
		...
		bank.sysex[getPatchStart(patchNum)+ 83]=(byte)((p.sysex[6+102]*2+p.sysex[6+101]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
		...
		bank.sysex[getPatchStart(patchNum)+ 96]=(byte)((p.sysex[6+117]*4+p.sysex[6+116]));	// Kbd Level Scale Right Curve .(0-3)
													// | Left Curve ...............(0-3)
		bank.sysex[getPatchStart(patchNum)+ 97]=(byte)((p.sysex[6+125]*8+p.sysex[6+118]));	// Osc Detune .................(0-14)
													// | Kbd Rate Scaling .........(0-7)
		...
		bank.sysex[getPatchStart(patchNum)+100]=(byte)((p.sysex[6+123]*2+p.sysex[6+122]));	// Osc Frequency Coarse .......(0-31)
													// | Osc Mode .................(0-1)
	...
	public Patch getPatch(Patch bank, int patchNum)	//Gets a patch from the bank, converting it as needed
	{
		try {
			...
			ErrorMsg.reportError(getManufacturerName()+" "+getModelName(),"Error in "+getDriverName(),e);
			return null;
		}
	}
	...
	public Patch createNewPatch()	// create a bank with 32 "init voice"-patches
	{
		...
		Patch v = new Patch(DX7Constants.INIT_VOICE, getDevice());	// single sysex
