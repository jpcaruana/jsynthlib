/*
 * JSynthlib -	generic "System Setup" Editor No.2" for Yamaha DX7 Family
 *		(used by DX7-II, DX7s)
 * ========================================================
 * @version $Id$
...
public class DX7FamilySystemSetupIIEditor2 extends DX7FamilySystemSetupIIEditor
{
	public DX7FamilySystemSetupIIEditor2(String name, Patch patch)
	{
		super (name, patch);
