 ...
 * file:    YamahaDX7sMicroTuningBankDriver.java
 * date:    25.02.2003
 * @version 0.1
 *
...
public class YamahaDX7sMicroTuningBankDriver extends BankDriver
{
  public YamahaDX7sMicroTuningBankDriver()
  {
    ...
    patchNameStart=0;
    patchNameSize=0;
    bankNumbers  = DX7sConstants.BANK_NUMBERS_MICRO_TUNING_BANK;
    patchNumbers = DX7sConstants.PATCH_NUMBERS_MICRO_TUNING_BANK;
  ...
  public void storePatch (Patch p, int bankNum,int patchNum)
  {
    if( ((YamahaDX7sDevice)(PatchEdit.appConfig.getDevice(getDeviceNum()))).getTipsMsgFlag()==1 )
          ...
          JOptionPane.showMessageDialog(PatchEdit.instance,
                                        getDriverName()+"Driver:"+ DX7sStrings.MICRO_TUNING_CARTRIDGE_STRING,
