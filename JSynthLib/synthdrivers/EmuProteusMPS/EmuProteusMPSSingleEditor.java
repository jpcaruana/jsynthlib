...
//Source Pane															*
   ...
   {     
     ...
     gbc.weightx=0;
   addWidget(panel,new EnvelopeWidget("Alternate Envelope",patch,new EnvelopeNode [] {
        new EnvelopeNode(0,0,null,0,0,null,0,false,null,null,null,null),     
	new EnvelopeNode(0,99,new MPSModel(patch,0x1D+i*18),0,0,null,0,false,new MPSSender(29+i*18),null,"Dly",null),     	
	new EnvelopeNode(0,99,new MPSModel(patch,0x20+i*18),100,100,null,25,false,new MPSSender(32+i*18),null,"A",null),
	new EnvelopeNode(0,99,new MPSModel(patch,0x21+i*18),5000,5000,null,0,false,new MPSSender(33+i*18),null,"Hld",null),     	
	new EnvelopeNode(0,99,new MPSModel(patch,0x22+i*18),0,99,new MPSModel(patch,0x23+i*18),25,false,new MPSSender(34+i*18),new MPSSender(35+i*18),"D","S"),
        new EnvelopeNode(100,100,null,5000,5000,null,0,false,null,null,null,null),     
	new EnvelopeNode(0,100,new MPSModel(patch,0x24+i*18),0,0,null,0,false,new MPSSender(36+i*18),null,"R",null),
      }     ),0,0,3,5,33);
 ...
 // Auxillary Envelope										*
  ...
  JPanel auxPane=new JPanel();
   ...
   addWidget(auxPane,new EnvelopeWidget("Auxilery Envelope                             ",patch,new EnvelopeNode [] {
        new EnvelopeNode(0,0,null,0,0,null,0,false,null,null,null,null),     
	new EnvelopeNode(0,99,new MPSModel(patch,0x4A),0,0,null,0,false,new MPSSender(74),null,"Dly",null),     	
	new EnvelopeNode(0,99,new MPSModel(patch,0x4B),100,100,null,25,false,new MPSSender(75),null,"A",null),
	new EnvelopeNode(0,99,new MPSModel(patch,0x4C),5000,5000,null,0,false,new MPSSender(76),null,"Hld",null),     	
	new EnvelopeNode(0,99,new MPSModel(patch,0x4D),0,99,new MPSModel(patch,0x4E),25,false,new MPSSender(77),new MPSSender(78),"D","S"),
        new EnvelopeNode(100,100,null,5000,5000,null,0,false,null,null,null,null),     
	new EnvelopeNode(0,100,new MPSModel(patch,0x4F),0,0,null,0,false,new MPSSender(79),null,"R",null),
      }     ),0,0,3,5,49);
