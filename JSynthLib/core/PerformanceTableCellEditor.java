...
public class PerformanceTableCellEditor implements TableCellEditor, TableModelListener {
    ...
    /**
     * Constructs a PerformanceTableCellEditor.
     * create default editor
     *
     * @see TableCellEditor
     * @see DefaultCellEditor
     */
    public PerformanceTableCellEditor(JTable table) {
        this.table = table;
    ...
    protected void selectEditor(MouseEvent e) {
        ...
        if ((row!=oldrow)||(col!=oldcol)) {
            ...
            driver=((PerformanceListModel)table.getModel()).getPerformanceAt(row).getPatch().getDriver();
