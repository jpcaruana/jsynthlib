...
public class PrefsDialog extends JDialog 
{
	...
	private static final int CANCEL = 0x02; // private. Don't let people specify just a cancel
	private static final int APPLY = 0x04; // private. Don't let people specify just an apply
    ...
    JFrame p;
	Vector configpanels;
	int buttonsAllowed = OK_CANCEL_APPLY;
	...
	/**
	* This adds a tab to the configuration dialog box. Actually, it merely adds it to the vector which
	* holds all of the panels. The actual tabbed panes won't be created unless you call this.init() - emenaker 2003.03.12
