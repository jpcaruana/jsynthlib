...
class KawaiK5000ADDSingleEditor extends PatchEditorFrame {
    final String[] noteName = new String[] { "C#-2", "D-2", "D#-2", "E-2",
            ...
            "D-1", "D#-1", "E-1", "F-1", "F#-1", "G-1", "G#-1", "A-1", "A#-1",
            "B-1", "C0", "C#0", "D0", "D#0", "E0", "F0", "F#0", "G0", "G#0",
    ...
    final String[] macroList = new String[] { "Pitch", "Cutoff", "Level",
            "Vibrato Depth", "Growl Depth", "Tremolo Depth", "LFO Speed",
            "Attack Time", "Decay 1 Time", "Release Time", "Velocity",
            "Resonance", "Panpot", "FF Bias", "FF Env/LFO Depth",
            "FF Env/LFO Speed", "Harmonic Lo", "Harmonic Hi", "Harmonic Even",
            "Harmonic Odd" };

    final String[] switchList = new String[] { "Off", "Harm Max",
            "Harm Bright", "Harm Dark", "Harm Saw", "Select Loud", "Add Loud",
            "Add 5th", "Add Odd", "Add Even", "HE #1", "HE #2", "HE Loop",
    ...
    public KawaiK5000ADDSingleEditor(Patch patch) {
        ...
        final ScrollBarWidget numSources = new ScrollBarWidget("Num Sources",
                patch, 2, 6, 0, new K5kCmnModel(patch, 51), new K5kCmnSender(
                        0x0B));
        ...
        addWidget(cmn2Panel, new ComboBoxWidget("AM", patch, new K5kCmnModel(
                patch, 53), new K5kCmnSender(0x0D), new String[] { "None",
