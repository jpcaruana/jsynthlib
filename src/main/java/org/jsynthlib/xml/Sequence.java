...
public class Sequence {
	...
	public String[] getSequence() throws CompilationFailedException, IOException {
		GroovyShell groovyShell = PluginRegistry.groovyShell();
		Closure c = (Closure) groovyShell.evaluate("return { " + variable + " -> " + value + " }");
	...
	public void setStart(String s) { start = Integer.decode(s).intValue(); }
	public void setEnd(String s) { end = Integer.decode(s).intValue(); }
